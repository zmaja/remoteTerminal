// This module is obtained from Pavel Gurenko.
// Original source:https://github.com/pgurenko/DXGICaptureSample/
// Detailed licence in file: LICENSE.DXGIManager
...
public:
    ...
    HRESULT ReleaseDXGIOutputDuplication();
